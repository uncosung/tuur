...
export default props => {
  return (
    <Fragment>
      ...
      <SearchPackages {...props} dates={props.dates} handleDates={props.handleDates} toggleStatus={props.toggleStatus} tags={props.tags} location={props.location} handleSearch={props.search}/>
    </Fragment>
  );
};
