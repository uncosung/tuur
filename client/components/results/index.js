...
export default props => {
  return (
    <Fragment>
      <SearchBar dates={props.dates} handleDates={props.handleDates} toggleStatus={props.toggleStatus} tags={props.tags} location={props.location} handleSearch={props.search}/>
